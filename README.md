...
#### 20201106(금)
- UI디자인 핵심용어
- UI(User Interface): 유저 인터페이스 2가지(아래)
- CLI (Command Line Interface) 커맨드 라인인터페이스 
- GUI (Graphic User Interface) 그래픽 유저인터페이스 
- Needs(니즈) 요구사항
- Context(맥락) 줄거리가 있는내용 축약본=목차본
- 페르소나(Persona) 영화용어
- 페르소나 : 가상유저를 만들어서 사용자 요구사항 확인
- 브레인스토밍 : 무한발표 - 생각나는대로 말하는 회의방식
#### 20201105(목)
- css : 계층구조에서 > 의미는  
